...
1. **Montar Infraestrutura do Esquadrão:**
   - Execute o script `scripts/gerenciador_equipe.py` com o comando `iniciar` para criar a estrutura de pastas e arquivos necessários em `.agents/skills/sandeco-maestro/.antigravity/equipe/`.
...
3. **Validação de Skills:**
   - Verifique se cada skill informada existe no diretório `.agents/skills/`.
