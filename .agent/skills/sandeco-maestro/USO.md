...
## Inicialização
- **Comando:** "Maestro, prepare o esquadrão para [PROJETO]."
- **Exemplo Real:** "Maestro, prepare o esquadrão integrando [@[c:\python-projects\orquestrador\.agent\skills\youtube-descricoes] @[c:\python-projects\orquestrador\.agent\skills\youtube-tags] @[c:\python-projects\orquestrador\.agent\skills\youtube-titulos] ]."
- **Efeito:** Cria a infraestrutura de pastas e arquivos.

## Gestão de Tarefas
- **Comando:** "Maestro, delegue ao [PAPEL] a função de [AVROCAL]."
- **Efeito:** Registra no `registro_atividades.json`.

## Aprovação de Planos
- **Fluxo:** "Agente, envie o plano -> Maestro aprova."
